...
from oddsapi.database.data_models import FonbetEvent
from oddsapi.database.repository.bet import upsert_fonbet_bet
...
class FonbetListener(ParserListener):
    ...
    async def handle_event(
        self, event: FonbetEvent, session: AsyncSession
    ) -> ProcessStatus:
        ...
        updated = await upsert_fonbet_bet(event, event_date, fixture, session)

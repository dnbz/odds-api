...
from oddsapi.database.data_models import MarathonEvent
from oddsapi.database.repository.bet import upsert_marathon_bet
...
class MarathonListener(ParserListener):
    ...
    async def handle_event(
        self, event: MarathonEvent, session: AsyncSession
    ) -> ProcessStatus:
        ...
        updated = await upsert_marathon_bet(event, event_date, fixture, session)
